...
function _WebGLInputOnBlur(id, cb) {
 ...
 input.onblur = function() {
  !!Runtime.dynCall ? Runtime.dynCall("vi", cb, [ id ]) : function(a1) {
...
function _WebGLInputOnEditEnd(id, cb) {
 ...
 input.onchange = function() {
  ...
  !!Runtime.dynCall ? Runtime.dynCall("vii", cb, [ id, buffer ]) : function(a1, a2) {
   dynCall_vii.apply(null, [ cb, a1, a2 ]);
  }(id, buffer);
 };
}
...
function _WebGLInputOnKeyboardEvent(id, cb) {
 ...
 var func = function(mode, e) {
  if (e instanceof KeyboardEvent) {
   ...
   !!Runtime.dynCall ? Runtime.dynCall("viiiiiii", cb, [ id, mode, key, code, shift, ctrl, alt ]) : function(a1, a2, a3, a4, a5, a6, a7) {
    dynCall_viiiiiii.apply(null, [ cb, a1, a2, a3, a4, a5, a6, a7 ]);
   }(id, mode, key, code, shift, ctrl, alt);
  }
 };
 input.addEventListener("keydown", function(e) {
  func(1, e);
 ...
 input.addEventListener("keydown", function(e) {
  if (e.which && e.which === 9 || e.keyCode && e.keyCode === 9) {
   ...
   if (input.enableTabText) {
    ...
    !!Runtime.dynCall ? Runtime.dynCall("vii", cb, [ id, e.shiftKey ? -1 : 1 ]) : function(a1, a2) {
     dynCall_vii.apply(null, [ cb, a1, a2 ]);
    }(id, e.shiftKey ? -1 : 1);
   }
  }
...
function _WebGLWindowOnBlur(cb) {
 this.blurListener = function() {
  !!Runtime.dynCall ? Runtime.dynCall("v", cb, []) : function() {
   dynCall_v.call(null, cb);
  }();
 };
